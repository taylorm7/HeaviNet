...
[x_down1, x_fx1, y1, level_1, z1] = create_level(1, song, fx, bits);
[x_down2, x_fx2, y2, level_2, z2] = create_level(2, song, fx, bits);
[x_down3, x_fx3, y3, level_3, z3] = create_level(3, song, fx, bits);
[x_down4, x_fx4, y4, level_4, z4] = create_level(4, song, fx, bits);
[x_down5, x_fx5, y5, level_5, z5] = create_level(5, song, fx, bits);
[x_down6, x_fx6, y6, level_6, z6] = create_level(6, song, fx, bits);
[x_down7, x_fx7, y7, level_7, z7] = create_level(7, song, fx, bits);
%[x_down8, x_fx8, y8, level_8, z8] = create_level(8, song, fx, bits);

[ytrue_1] = create_solution(1, song, fx, bits);
[ytrue_2] = create_solution(2, song, fx, bits);
[ytrue_3] = create_solution(3, song, fx, bits);
[ytrue_4] = create_solution(4, song, fx, bits);
[ytrue_5] = create_solution(5, song, fx, bits);
[ytrue_6] = create_solution(6, song, fx, bits);
[ytrue_7, y_final8] = create_solution(7, song, fx, bits);
